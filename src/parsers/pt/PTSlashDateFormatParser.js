...
var PATTERN = new RegExp('(\\W|^)' +
    '(?:' +
        '((?:domingo|dom|segunda|segunda-feira|seg|terça|terca|terça-feira|terca-feira|ter|quarta|quarta-feira|qua|quinta|quinta-feira|qui|sexta|sexta-feira|sex|s[áa]bado|sab))' +
        '\\s*\\,?\\s*' +
    ')?' +
...
var DAYS_OFFSET = { 'domingo': 0, 'dom': 0,
