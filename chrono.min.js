...
},{"../../result":72,"../parser":45,"moment":2}],23:[function(require,module,exports){
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(agora|esta\s*(manhã|manha|tarde|noite)|(ontem|manhã)\s*por\s*la\s*(manhã|tarde|noite)|hoje|manhã|ontem|noite)(?=\W|$)/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,e,a,r){var t=a[0].substr(a[1].length),s=a.index+a[1].length,i=new ParsedResult({index:s,text:t,ref:e}),n=moment(e),o=n.clone(),m=t.toLowerCase().replace(/\s+/g," ");if("manhã"==m)n.hour()>1&&o.add(1,"day");else if("ontem"==m)o.add(-1,"day");else if("anoite"==m)i.start.imply("hour",0),n.hour()>6&&o.add(-1,"day");else if(m.match("esta")){var l=a[3].toLowerCase();"tarde"==l?i.start.imply("hour",18):"manhã"==l?i.start.imply("hour",6):"noite"==l&&(i.start.imply("hour",22),i.start.imply("meridiem",1))}else if(m.match(/por\s*la/)){var d=a[4].toLowerCase();"ontem"===d?o.add(-1,"day"):"manhã"===d&&o.add(1,"day");var l=a[5].toLowerCase();"tarde"==l?i.start.imply("hour",18):"manhã"==l?i.start.imply("hour",9):"noite"==l&&(i.start.imply("hour",22),i.start.imply("meridiem",1))}else m.match("ahora")&&(i.start.imply("hour",n.hour()),i.start.imply("minute",n.minute()),i.start.imply("second",n.second()),i.start.imply("millisecond",n.millisecond()));return i.start.assign("day",o.date()),i.start.assign("month",o.month()+1),i.start.assign("year",o.year()),i.tags.PTCasualDateParser=!0,i}};
},{"../../result":72,"../parser":45,"moment":2}],47:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(dentro\s*de|en)\s*([0-9]+|mei[oa]|uma?)\s*(minutos?|horas?|dias?)\s*(?=(?:\W|$))/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,a,r,e){var s=r.index+r[1].length,t=r[0];t=r[0].substr(r[1].length,r[0].length-r[1].length);var n=new ParsedResult({index:s,text:t,ref:a}),i=parseInt(r[3]);isNaN(i)&&(i=r[3].match(/mei/)?.5:1);var m=moment(a);return r[4].match(/dia/)?(m.add(i,"d"),n.start.assign("year",m.year()),n.start.assign("month",m.month()+1),n.start.assign("day",m.date()),n):(r[4].match(/hora/)?m.add(i,"hour"):r[4].match(/minuto/)&&m.add(i,"minute"),n.start.imply("year",m.year()),n.start.imply("month",m.month()+1),n.start.imply("day",m.date()),n.start.assign("hour",m.hour()),n.start.assign("minute",m.minute()),n.tags.PTDeadlineFormatParser=!0,n)}};
},{"../../result":72,"../parser":45,"moment":2}],48:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/PT"),DAYS_OFFSET=util.WEEKDAY_OFFSET,PATTERN=new RegExp("(\\W|^)(?:(Domingo|Segunda|Terça|Quarta|Quinta|Sexta|Sábado|Sabado|Dom|Seg|Ter|Qua|Qui|Sex|Sab|Segunda-feira|Terça-feira|Terca-feira|Quarta-feira|Quinta-feira|Sexta-feira)\\s*,?\\s*)?([0-9]{1,2})(?:º|ª|°)?(?:\\s*(?:desde|de|\\-|\\–|al?|até|ate|\\s)\\s*([0-9]{1,2})(?:º|ª|°)?)?\\s*(?:de)?\\s*(Jan(?:eiro|\\.)?|Fev(?:ereiro|\\.)?|Mar(?:ço|\\.)?|Mar(?:co|\\.)?|Abr(?:il|\\.)?|Mai(?:o|\\.)?|Jun(?:ho|\\.)?|Jul(?:ho|\\.)?|Ago(?:sto|\\.)?|Set(?:embro|\\.)?|Out(?:ubro|\\.)?|Nov(?:embro|\\.)?|Dez(?:embro|\\.)?)(?:\\s*(?:de?)?(\\s*[0-9]{1,4}(?![^\\s]\\d))(\\s*[ad]\\.?\\s*c\\.?|a\\.?\\s*d\\.?)?)?(?=\\W|$)","i"),WEEKDAY_GROUP=2,DATE_GROUP=3,DATE_TO_GROUP=4,MONTH_NAME_GROUP=5,YEAR_GROUP=6,YEAR_BE_GROUP=7;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,a,t,r){var s=new ParsedResult({text:t[0].substr(t[1].length,t[0].length-t[1].length),index:t.index+t[1].length,ref:a}),n=t[MONTH_NAME_GROUP];n=util.MONTH_OFFSET[n.toLowerCase()];var i=t[DATE_GROUP];i=parseInt(i);var o=null;if(t[YEAR_GROUP]&&(o=t[YEAR_GROUP],o=parseInt(o),t[YEAR_BE_GROUP]?/a\.?\s*c\.?/i.test(t[YEAR_BE_GROUP])&&(o=-o):o<100&&(o+=2e3)),o)s.start.assign("day",i),s.start.assign("month",n),s.start.assign("year",o);else{var E=moment(a);E.month(n-1),E.date(i),E.year(moment(a).year());var d=E.clone().add(1,"y"),u=E.clone().add(-1,"y");Math.abs(d.diff(moment(a)))<Math.abs(E.diff(moment(a)))?E=d:Math.abs(u.diff(moment(a)))<Math.abs(E.diff(moment(a)))&&(E=u),s.start.assign("day",i),s.start.assign("month",n),s.start.imply("year",E.year())}if(t[WEEKDAY_GROUP]){var P=t[WEEKDAY_GROUP];P=util.WEEKDAY_OFFSET[P.toLowerCase()],s.start.assign("weekday",P)}return t[DATE_TO_GROUP]&&(s.end=s.start.clone(),s.end.assign("day",parseInt(t[DATE_TO_GROUP]))),s.tags.PTMonthNameLittleEndianParser=!0,s}};
},{"../../result":72,"../../utils/PT":78,"../parser":45,"moment":2}],49:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)(?:((?:domingo|dom|segunda|segunda-feira|seg|terça|terca|terça-feira|terca-feira|ter|quarta|quarta-feira|qua|quinta|quinta-feira|qui|sexta|sexta-feira|sex|s[áa]bado|sab))\\s*\\,?\\s*)?([0-1]{0,1}[0-9]{1})[\\/\\.\\-]([0-3]{0,1}[0-9]{1})(?:[\\/\\.\\-]([0-9]{4}s*,?s*|[0-9]{2}s*,?s*))?(\\W|$)","i"),DAYS_OFFSET={domingo:0,dom:0,segunda:1,"segunda-feira":1,seg:1,"terça":2,terca:2,"terça-feira":2,"terca-feira":2,ter:2,quarta:3,"quarta-feira":3,qua:3,quinta:4,"quinta-feira":4,qui:4,sexta:5,"sexta-feira":5,sex:5,sabado:6,"sábado":6,sab:6},OPENNING_GROUP=1,ENDING_GROUP=6,WEEKDAY_GROUP=2,MONTH_GROUP=4,DAY_GROUP=3,YEAR_GROUP=5;exports.Parser=function(e){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,a,r,t){if("/"==r[OPENNING_GROUP]||"/"==r[ENDING_GROUP])return void(r.index+=r[0].length);var s=r.index+r[OPENNING_GROUP].length,e=r[0].substr(r[OPENNING_GROUP].length,r[0].length-r[ENDING_GROUP].length),n=new ParsedResult({text:e,index:s,ref:a});if(!e.match(/^\d\.\d$/)&&!e.match(/^\d\.\d{1,2}\.\d{1,2}$/)&&(r[YEAR_GROUP]||!(r[0].indexOf("/")<0))){var i=r[YEAR_GROUP]||moment(a).year()+"",u=r[MONTH_GROUP],P=r[DAY_GROUP];if(u=parseInt(u),P=parseInt(P),i=parseInt(i),(u<1||u>12)&&u>12){if(!(P>=1&&P<=12&&u>=13&&u<=31))return null;var d=u;u=P,P=d}return P<1||P>31?null:(i<100&&(i+=i>50?1900:2e3),n.start.assign("day",P),n.start.assign("month",u),n.start.assign("year",i),r[WEEKDAY_GROUP]&&n.start.assign("weekday",DAYS_OFFSET[r[WEEKDAY_GROUP].toLowerCase()]),n.tags.PTSlashDateFormatParser=!0,n)}}};
},{"../../result":72,"../parser":45,"moment":2}],50:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)faz\s*([0-9]+|mei[oa]|uma?)\s*(minutos?|horas?|semanas?|dias?|m[eê]s(es)?|anos?)(?=(?:\W|$))/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(a,t,e,r){if(e.index>0&&a[e.index-1].match(/\w/))return null;var a=e[0];a=e[0].substr(e[1].length,e[0].length-e[1].length),index=e.index+e[1].length;var s=new ParsedResult({index:index,text:a,ref:t}),n=parseInt(e[2]);isNaN(n)&&(n=e[2].match(/mei/)?.5:1);var m=moment(t);return e[3].match(/hora/)||e[3].match(/minuto/)?(e[3].match(/hora/)?m.add(-n,"hour"):e[3].match(/minuto/)&&m.add(-n,"minute"),s.start.imply("day",m.date()),s.start.imply("month",m.month()+1),s.start.imply("year",m.year()),s.start.assign("hour",m.hour()),s.start.assign("minute",m.minute()),s.tags.PTTimeAgoFormatParser=!0,s):e[3].match(/semana/)?(m.add(-n,"week"),s.start.imply("day",m.date()),s.start.imply("month",m.month()+1),s.start.imply("year",m.year()),s.start.imply("weekday",m.day()),s):(e[3].match(/dia/)&&m.add(-n,"d"),e[3].match(/m[eê]s/)&&m.add(-n,"month"),e[3].match(/ano/)&&m.add(-n,"year"),s.start.assign("day",m.date()),s.start.assign("month",m.month()+1),s.start.assign("year",m.year()),s)}};
},{"../../result":72,"../parser":45,"moment":2}],51:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,ParsedComponents=require("../../result").ParsedComponents,FIRST_REG_PATTERN=new RegExp("(^|\\s|T)(?:(?:às?|à?|desde|de)\\s*)?(\\d{1,4}|meio-dia|meia-noite)(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\:|\\：)(\\d{2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),SECOND_REG_PATTERN=new RegExp("^\\s*(\\-|\\–|\\~|\\〜|a(?:s*as)?|\\?)\\s*(\\d{1,4})(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\.|\\:|\\：)(\\d{1,2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),HOUR_GROUP=2,MINUTE_GROUP=3,SECOND_GROUP=4,AM_PM_HOUR_GROUP=5;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return FIRST_REG_PATTERN},this.extract=function(e,t,r,n){if(r.index>0&&e[r.index-1].match(/\w/))return null;var s=moment(t),a=new ParsedResult;a.ref=t,a.index=r.index+r[1].length,a.text=r[0].substring(r[1].length),a.tags.PTTimeExpressionParser=!0,a.start.imply("day",s.date()),a.start.imply("month",s.month()+1),a.start.imply("year",s.year());var i=0,u=0,l=-1;if(null!=r[SECOND_GROUP]){var d=parseInt(r[SECOND_GROUP]);if(d>=60)return null;a.start.assign("second",d)}if(r[HOUR_GROUP].toLowerCase().match(/meio-dia/)?(l=1,i=12):"meia-noite"==r[HOUR_GROUP].toLowerCase()?(l=0,i=0):i=parseInt(r[HOUR_GROUP]),null!=r[MINUTE_GROUP]?u=parseInt(r[MINUTE_GROUP]):i>100&&(u=i%100,i=parseInt(i/100)),u>=60)return null;if(i>24)return null;if(i>=12&&(l=1),null!=r[AM_PM_HOUR_GROUP]){if(i>12)return null;var P=r[AM_PM_HOUR_GROUP][0].toLowerCase();"a"==P&&(l=0,12==i&&(i=0)),"p"==P&&(l=1,12!=i&&(i+=12))}if(a.start.assign("hour",i),a.start.assign("minute",u),l>=0&&a.start.assign("meridiem",l),!(r=SECOND_REG_PATTERN.exec(e.substring(a.index+a.text.length))))return a.text.match(/^\d+$/)?null:a;if(r[0].match(/^\s*(\+|\-)\s*\d{3,4}$/))return a;null==a.end&&(a.end=new ParsedComponents(null,a.start.date()));var i=0,u=0,l=-1;if(null!=r[SECOND_GROUP]){var d=parseInt(r[SECOND_GROUP]);if(d>=60)return null;a.end.assign("second",d)}if(i=parseInt(r[2]),null!=r[MINUTE_GROUP]){if((u=parseInt(r[MINUTE_GROUP]))>=60)return a}else i>100&&(u=i%100,i=parseInt(i/100));if(u>=60)return null;if(i>24)return null;if(i>=12&&(l=1),null!=r[AM_PM_HOUR_GROUP]){if(i>12)return null;"a"==r[AM_PM_HOUR_GROUP][0].toLowerCase()&&(l=0,12==i&&(i=0,a.end.isCertain("day")||a.end.imply("day",a.end.get("day")+1))),"p"==r[AM_PM_HOUR_GROUP][0].toLowerCase()&&(l=1,12!=i&&(i+=12)),a.start.isCertain("meridiem")||(0==l?(a.start.imply("meridiem",0),12==a.start.get("hour")&&a.start.assign("hour",0)):(a.start.imply("meridiem",1),12!=a.start.get("hour")&&a.start.assign("hour",a.start.get("hour")+12)))}else i>=12&&(l=1);return a.text=a.text+r[0],a.end.assign("hour",i),a.end.assign("minute",u),l>=0&&a.end.assign("meridiem",l),a.end.date().getTime()<a.start.date().getTime()&&a.end.imply("day",a.end.get("day")+1),a}};
},{"../../result":72,"../parser":45,"moment":2}],52:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,updateParsedComponent=require("../en/ENWeekdayParser").updateParsedComponent,DAYS_OFFSET={domingo:0,dom:0,segunda:1,"segunda-feira":1,seg:1,"terça":2,terca:2,"terça-feira":2,"terca-feira":2,ter:2,quarta:3,"quarta-feira":3,qua:3,quinta:4,"quinta-feira":4,qui:4,sexta:5,"sexta-feira":5,sex:5,sabado:6,"sábado":6,sab:6},PATTERN=new RegExp("(\\W|^)(?:(?:\\,|\\(|\\（)\\s*)?(?:(este|passado|pr[oó]ximo)\\s*)?("+Object.keys(DAYS_OFFSET).join("|")+")(?:\\s*(?:\\,|\\)|\\）))?(?:\\s*(este|passado|pr[óo]ximo)\\s*week)?(?=\\W|$)","i"),PREFIX_GROUP=2,WEEKDAY_GROUP=3,POSTFIX_GROUP=4;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,r,a,t){var s=a.index+a[1].length,e=a[0].substr(a[1].length,a[0].length-a[1].length),n=new ParsedResult({index:s,text:e,ref:r}),i=a[WEEKDAY_GROUP].toLowerCase(),o=DAYS_OFFSET[i];if(void 0===o)return null;var u=null,P=a[PREFIX_GROUP],d=a[POSTFIX_GROUP];if(P||d){var p=P||d;p=p.toLowerCase(),"passado"==p?u="this":"próximo"==p||"proximo"==p?u="next":"este"==p&&(u="this")}return updateParsedComponent(n,r,o,u),n.tags.PTWeekdayParser=!0,n}};
